...
/*    */ 
/*    */ public class FirefliesParticles
/*    */   extends ParticleRunnable
/*    */ {
/*    */   private final float speed;
/*    */   private final float height;
/* 13 */   private double j = 0.0D; private final float radius; private final float r_speed; private final int amount;
/*    */   
/*    */   public FirefliesParticles(ParticleData paramParticleData, PlayerData paramPlayerData) {
...
/* 30 */       this.particle.display(location.clone().add(Math.cos(d) * this.radius, this.height, Math.sin(d) * this.radius), this.speed);
/*    */     } 
/*    */     
/* 33 */     this.j += 0.06544984694978735D * this.r_speed;
/* 34 */     this.j -= (this.j > 6.283185307179586D) ? 6.283185307179586D : 0.0D;
/*    */   }
/*    */ }


/* Location:              O:\QQ\203636290\FileRecv\MMOItems-6.9.4.jar!\net\Indyuce\mmoitems\particle\FirefliesParticles.class
