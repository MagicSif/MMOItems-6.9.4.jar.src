...
/*  32 */     super("COMPATIBLE_IDS", VersionMaterial.COMMAND_BLOCK.toMaterial(), "Compatible IDs", new String[] { "The item ids this skin is", "compatible with." }, new String[] { "skin" }, new org.bukkit.Material[0]);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  46 */       (new StatEdition(paramEditionInventory, ItemStats.COMPATIBLE_IDS, new Object[0])).enable(new String[] { "Write in the chat the item id you want to add." });
/*     */     }
/*  48 */     if (paramInventoryClickEvent.getAction() != InventoryAction.PICKUP_HALF || !paramEditionInventory.getEditedSection().contains("compatible-ids"))
/*     */       return; 
/*  50 */     List<String> list = paramEditionInventory.getEditedSection().getStringList("compatible-ids");
/*  51 */     if (list.size() < 1) {
/*     */       return;
/*     */     }
/*  54 */     String str = list.get(list.size() - 1);
/*  55 */     list.remove(str);
/*  56 */     paramEditionInventory.getEditedSection().set("compatible-ids", list);
...
/*  64 */     List<String> list = paramEditionInventory.getEditedSection().contains("compatible-ids") ? paramEditionInventory.getEditedSection().getStringList("compatible-ids") : new ArrayList();
/*  65 */     list.add(paramString.toUpperCase());
/*  66 */     paramEditionInventory.getEditedSection().set("compatible-ids", list);
/*  67 */     paramEditionInventory.registerTemplateEdition();
/*  68 */     paramEditionInventory.getPlayer().sendMessage(MMOItems.plugin.getPrefix() + "Compatible IDs successfully added.");
/*     */   }
/*     */ 
/*     */   
...
/*     */     } 
/*  79 */     paramList.add("");
/*  80 */     paramList.add(ChatColor.YELLOW + "►" + " Click to add a new id.");
/*  81 */     paramList.add(ChatColor.YELLOW + "►" + " Right click to remove the last id.");
/*     */   }
/*     */ 
/*     */   
/*     */   @NotNull
...
/*  94 */     paramItemStackBuilder.getLore().insert("compatible-ids", arrayList);
/*     */ 
/*     */     
...
/*     */       
/* 149 */       return new StringListData(jsonArray);
/* 150 */     } catch (JsonSyntaxException|IllegalStateException jsonSyntaxException) {
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/* Location:              O:\QQ\203636290\FileRecv\MMOItems-6.9.4.jar!\net\Indyuce\mmoitems\stat\CompatibleIds.class
